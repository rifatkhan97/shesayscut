  ...
  return (
    <section className="relative w-full h-screen min-h-[600px] overflow-hidden bg-[#0A0A0A]">
      ...
      >
        ...
        />
        {/* Very subtle darken so white text reads clearly */}
        <div className="absolute inset-0 bg-black/35" />
      </motion.div>

      {/* Brand anchored to bottom-left — Division / Frenzy style */}
      <div className="absolute inset-0 flex flex-col justify-between p-6 sm:p-10 lg:p-14">
        ...
        <div className="flex items-end justify-between">
          ...
          >
            ...
            <h1 className="font-sans font-black text-[clamp(2.6rem,6vw,5.5rem)] text-white leading-[0.92] tracking-tighter">
              She<br />Says<br />Cut.
            </h1>
          </motion.div>
