...
export default function HomePageClient() {
  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <section className="w-full bg-[#F5F4F0] px-6 sm:px-10 lg:px-14 py-20 sm:py-28" aria-label="Studio Manifesto">
      ...
      <section className="w-full bg-[#EDECE8] px-6 sm:px-10 lg:px-14 py-20 sm:py-28" aria-label="Selected Works">
        <div className="max-w-[1600px] mx-auto">

          {/* Section label row */}
          <div className="flex items-center justify-between mb-12 sm:mb-16 pb-5 border-b border-black/10">
            <h2 className="font-sans text-[9px] tracking-[0.22em] uppercase text-[#8A8A8A]">Selected Works</h2>
            <Link
              href="/cinema"
      ...
      <section className="w-full bg-[#0A0A0A] px-6 sm:px-10 lg:px-14 py-20 sm:py-28" aria-label="Studio Services & Practice">
        <div className="max-w-[1600px] mx-auto">
